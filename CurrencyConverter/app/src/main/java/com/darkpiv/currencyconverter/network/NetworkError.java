...
public class NetworkError extends Throwable {
    ...
    public String getAppErrorMessage() {
        ...
        if (response != null) {
            ErrorResponse errorResponse = getJsonStringFromResponse(response);
            if (!TextUtils.isEmpty(errorResponse.getStatus())) return errorResponse.getStatus();
    ...
    protected ErrorResponse getJsonStringFromResponse(final retrofit2.Response<?> response) {
        try {
