...
public class MainActivity extends BaseActivity {
    public ArrayList<CurrencyRate> list_currency_rate_data;
    public ArrayList<CurrencyName> list_currency_name_data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < list_currency_name_data.size(); i++) {
            strings.add(list_currency_name_data.get(i).short_name);
        }
    ...
    public void add_currency_rates() {
        ...
        Log.d("XXX", "add_currency_rates: " + list_currency_rate_data.size());
    ...
    public void add_country_names() {
        ...
        Log.d("xxx", "add_country_names: " + list_currency_name_data.size());
    }
}